...
import { MERIDIAN_MAP } from '../maps/MeridianMap';
...
export class Game {
   ...
   *  from the menu. Created + wired by main.ts; ticked here for capture logic. */
  ...
  private tick = (now: number) => {
    ...
    if (this.koth) this.koth.update(dt);            // king-of-the-hill capture logic
