...
import { OWNER_SPAWN, THIEF_SPAWN, VAULT_POS } from '../maps/MansionMap';

export type HeistSide = 'thief' | 'owner';

/** How close (horizontally, on the cellar plane) the thief must get to the vault. */
const VAULT_REACH = 2.6;
