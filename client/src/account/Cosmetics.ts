...
export const KILL_EFFECTS: ReadonlyArray<KillEffectConfig> = [
  ...
  { id: 'shock-gold',    displayName: 'Golden Shock',   particleColor: 0xffd24a, tintColor: 0x2a2000, cost: 1400 },
  { id: 'burst-rose',    displayName: 'Rose Burst',     particleColor: 0xff86b0, tintColor: 0x2a0a18, cost: 2000 },
  { id: 'nova-azure',    displayName: 'Azure Nova',     particleColor: 0x4aa8ff, tintColor: 0x0a1830, cost: 3000 },
  { id: 'rift-spectral', displayName: 'Spectral Rift',  particleColor: 0x9affe0, tintColor: 0x06281f, cost: 5000 },
];
...
export const TRACERS: ReadonlyArray<TracerConfig> = [
  ...
  { id: 'tracer-rose',    displayName: 'Rose',         color: 0xff86b0, cost: 1300 },
  { id: 'tracer-azure',   displayName: 'Azure',        color: 0x4aa8ff, cost: 1700 },
  { id: 'tracer-spectral',displayName: 'Spectral',     color: 0x9affe0, cost: 2200 },
  { id: 'tracer-sunset',  displayName: 'Sunset',       color: 0xff7a3a, cost: 2900 },
];
...
export const FINISHES: ReadonlyArray<FinishConfig> = [
  ...
  { id: 'finish-rose',     displayName: 'Rose Gold',  emissive: 0x3a1420, swatch: 0xff86b0, cost: 1800 },
  { id: 'finish-azure',    displayName: 'Azure',      emissive: 0x0a2440, swatch: 0x4aa8ff, cost: 2200 },
  { id: 'finish-spectral', displayName: 'Spectral',   emissive: 0x0a3a30, swatch: 0x9affe0, cost: 4500 },
  { id: 'finish-onyx',     displayName: 'Onyx',       emissive: 0x101018, swatch: 0x2a2e3a, cost: 5000 },
];
