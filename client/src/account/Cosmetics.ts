...
export const WEAPON_SKINS: ReadonlyArray<WeaponSkinConfig> = [
  ...
  ...makeWeaponSkins('handcannon', 'Standard', [
    { displayName: 'Bounty',   color: 0xb88a3a },
    { displayName: 'Vendetta', color: 0xc23030 },
    { displayName: 'Deadeye',  color: 0x2b3340 },
  ]),
...
export const WEAPON_SKIN_ORDER = ['ar', 'smg', 'marksman', 'sniper', 'shotgun', 'lmg', 'railgun', 'handcannon', 'pistol'] as const;
