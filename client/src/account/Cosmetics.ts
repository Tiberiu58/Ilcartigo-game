...
export const WEAPON_SKINS: ReadonlyArray<WeaponSkinConfig> = [
  ...
  ...makeWeaponSkins('crossbow', 'Standard', [
    { displayName: 'Hunter',   color: 0x4a5a32 },
    { displayName: 'Mahogany', color: 0x7a5230 },
    { displayName: 'Venom',    color: 0x7fd23a },
  ]),
...
export const WEAPON_SKIN_ORDER = ['ar', 'smg', 'marksman', 'sniper', 'shotgun', 'lmg', 'railgun', 'crossbow', 'pistol'] as const;
