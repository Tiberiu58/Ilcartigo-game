 ...
 *
 * This file is duplicated in /client/src/networking/Protocol.ts — keep them in sync.
 ...
 * respawns (available=true). The heal is applied server-side to the grabber's
 * authoritative HP and shows up in the next Snapshot; `byId` lets the grabbing
 * client play local heal feedback (SFX / green flash).
 */
