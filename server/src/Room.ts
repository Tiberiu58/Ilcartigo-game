...
const SERVER_WEAPONS: Record<string, ServerWeapon> = {
  ...
  // Burst Rifle online: each of the 3 rounds arrives as its own single-target
  ...
  // Hand Cannon — heavy single-shot precision; mirrors the client MAGNUM_CONFIG.
  magnum:  { baseDamage: 60, headMul: 2.0,  falloffStart: 30,  falloffEnd: 80,  falloffMin: 0.6  },
