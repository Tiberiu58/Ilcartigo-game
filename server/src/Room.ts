...
const VALID_WEAPONS = new Set(['ar', 'smg', 'sniper', 'shotgun', 'marksman', 'lmg', 'railgun', 'crossbow', 'pistol']);
...
const SERVER_WEAPONS: Record<string, ServerWeapon> = {
  ...
  // Crossbow: silent one-shot-body skill weapon. Pinpoint, no falloff in-arena.
  crossbow:{ baseDamage: 100,headMul: 2.0,  falloffStart: 240, falloffEnd: 260, falloffMin: 0.95 },
