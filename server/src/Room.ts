...
const VALID_WEAPONS = new Set(['ar', 'smg', 'sniper', 'shotgun', 'marksman', 'lmg', 'railgun', 'magnum', 'pistol']);
...
const SERVER_WEAPONS: Record<string, ServerWeapon> = {
  ...
  magnum:  { baseDamage: 65, headMul: 1.7,  falloffStart: 30,  falloffEnd: 80,  falloffMin: 0.7  },
